import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{C as n}from"./iframe-DdzTufNt.js";import{t as r}from"./jsx-runtime-O9QVJvLM.js";import{C as i,D as a,S as o,T as s,b as c,n as l,t as u,x as d}from"./src-2Y0KcOWz.js";var f,p,m,h,g,_,v,y,b,x,S,C,w,T;t((()=>{f=e(n()),u(),p=r(),m={component:l},h={render:()=>{let e=(0,f.useRef)(null),[t,n]=(0,f.useState)(``);return(0,f.useEffect)(()=>{if(e.current)return l({text:t,onChange:n}).input(e.current)},[]),(0,p.jsx)(`div`,{ref:e,style:{backgroundColor:`white`,border:`solid 1px darkgray`,padding:8},children:t.split(`
