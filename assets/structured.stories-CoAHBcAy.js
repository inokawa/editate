  ...
  render: () => {
    ...
    return <div>
        ...
        padding: 8
          ...
          {doc.children[0].map((t, j) => "text" in t ? <span key={j}>{t.text || <br />}</span> : <span key={j} contentEditable={false} data-tag-value={t.value} style={{
  ...
  render: () => {
    ...
    return <div ref={ref} style={{
      ...
      padding: 8
        ...
        {doc.children.map((r, i) => <div key={i}>
            {r.map((t, j) => "text" in t ? <span key={j}>{t.text || <br />}</span> : <img key={j} src={t.src} style={{
          maxWidth: 200
        }} />)}
          </div>)}
      </div>;
  ...
  render: () => {
    ...
    return <div ref={ref} style={{
      ...
      padding: 8
        ...
        {doc.children.map((r, i) => <div key={i}>
            {r.map((t, j) => "text" in t ? <span key={j}>{t.text || <br />}</span> :
  ...
  render: () => {
    ...
    return <div>
        ...
        padding: 8
          ...
          {doc.children.map((r, i) => <div key={i}>
              {r.map((t, j) => "text" in t ? <span key={j}>{t.text || <br />}</span> : <Youtube key={j} id={t.id} />)}
            </div>)}
        </div>
      </div>;
  }
